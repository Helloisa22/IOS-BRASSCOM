...
let tagClasse = (document.querySelector('p.exemplo').innerHTML =
    'Alterei essa classe para Nutella');

// Acessando somente a classe
let elementoClass = (document.querySelector('.myclass').style.fontSize =
    'x-large');
// elementoClass.style.fontSize = 'x-large';

//Função chamadando pelo evento onclick()
const Clique = () => {
